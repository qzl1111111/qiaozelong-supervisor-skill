...
- Name: QiaoZelong Supervisor Skill
- Author: Qiao Zelong
- Initial public implementation date: **2026-08-13**
- Repository: `https://github.com/qzl1111111/qiaozelong-supervisor-skill`

Use the article citation when discussing the scientific origin of the architecture. Use `CITATION.cff` when citing the software implementation.
